...
urlpatterns = [
    ...
    path('delete-student/', vw.delete_student, name="delete-student"),
    path('delete-class/', vw.delete_class, name="delete-class"),
    path('delete-schedule/', vw.delete_schedule, name="delete-schedule"),
    path('delete-classroom/', vw.delete_classroom, name="delete-classroom"),
    path('delete-enrollments/', vw.delete_enrollments, name="delete-enrollments"),
    path('delete-users/', vw.delete_users, name="delete-users"),
    path('delete-profiles/', vw.delete_profiles, name="delete-profiles"),
    path('delete-parents/', vw.delete_parents, name="delete-parents"),
    path('delete-zipcode/', vw.delete_zipcode, name="delete-zipcode"),
    path('edit-student/', vw.edit_student, name="edit-student"),
    path('edit-class/', vw.edit_class, name="edit-class"),
    path('edit-schedule/', vw.edit_schedule, name="edit-schedule"),
    path('edit-classroom/', vw.edit_classroom, name="edit-classroom"),
    path('edit-enrollments/', vw.edit_enrollments, name="edit-enrollments"),
    path('edit-users/', vw.edit_users, name="edit-users"),
